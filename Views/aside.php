        ...
        if (is_dir($path)){
            ...
            if ($file != "." && $file != "..") {
                ...
                $short_path = substr($full_path, $pos + 2);
                    ...
                    if (is_dir($full_path)) {
                        echo '<li class="aside__list-item"><a href="index.php?folderPath='.$full_path.'&path='.$pathArray[$pathArrayLength].'"><i class="far fa-folder"></i><span class="aside__list-text">' . $file . '</span></a></li>';
